/* ============================================================================
   ...
   ============================================================================ */
SECTIONS_DATA["STREAM"] = "Distributed Systems & Streaming";
SECTIONS_DATA["ARCH"]   = "Software Architecture & Design";

CARDS_DATA.push(
  { sec:"ARCH", front:"The dual-write problem",
  ...
  { sec:"ARCH", front:"Transactional outbox pattern",
  ...
  { sec:"STREAM", front:"Why 'exactly-once' is usually 'effectively-once'",
  ...
  { sec:"STREAM", front:"Idempotent consumer",
  ...
  { sec:"STREAM", front:"Dead-letter queue (DLQ)",
  ...
  { sec:"STREAM", front:"Change data capture (CDC)",
...
"dual-write-problem":{ term:"The Dual-Write Problem", group:"Software Architecture & Design",
...
"transactional-outbox":{ term:"Transactional Outbox", group:"Software Architecture & Design",
...
"idempotency":{ term:"Idempotency", group:"Distributed Systems & Streaming",
...
"exactly-once":{ term:"Exactly-Once Semantics", group:"Distributed Systems & Streaming",
...
"dead-letter-queue":{ term:"Dead-Letter Queue (DLQ)", group:"Distributed Systems & Streaming",
...
"change-data-capture":{ term:"Change Data Capture (CDC)", group:"Distributed Systems & Streaming",
