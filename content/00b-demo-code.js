...
CARDS_DATA.push(
  { sec:"ARCH", front:"Transactional outbox — the atomic write (Java)",
...
public Payment create(CreatePaymentCommand cmd) {
  ...
  { sec:"STREAM", front:"Outbox relay query (SQL) — claim unsent events",
...
FOR UPDATE SKIP LOCKED;`) },
  ...
  { sec:"STREAM", front:"Delivery semantics, compared",
  ...
  { sec:"STREAM", front:"Reading consumer lag",
